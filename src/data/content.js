...
export const blogPosts = [
  {
    slug: "5-signs-your-fridge-needs-professional-repair",
    ...
    sections: [
      ...
      {
        heading: "1. The fridge feels warmer than it used to",
        body: [
      ...
      {
        heading: "2. Ice is building up somewhere it shouldn't",
        body: [
      ...
      {
        heading: "3. New noises, or existing noises getting louder",
        body: [
      ...
      {
        heading: "4. Water where it shouldn't be",
        body: [
      ...
      {
        heading: "5. It's running almost constantly",
        body: [
      ...
      {
        heading: "When to get it looked at",
        body: [
  ...
  {
    slug: "fridge-not-cooling-what-could-be-wrong",
    ...
    sections: [
      ...
      {
        heading: "Blocked or restricted airflow",
        body: [
      ...
      {
        heading: "Evaporator or condenser fan problems",
        body: [
      ...
      {
        heading: "A faulty temperature sensor or thermostat",
        body: [
      ...
      {
        heading: "Compressor start components or electrical supply",
        body: [
      ...
      {
        heading: "The sealed refrigeration system",
        body: [
      ...
      {
        heading: "Why diagnosis comes first",
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Age and condition together",
        body: [
      ...
      {
        heading: "Getting a diagnosis first",
        body: [
