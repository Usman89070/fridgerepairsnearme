    ...
    <section id="commercial" className="section commercial">
      <div className="container">
        <div className="section-head">
          ...
          <h2>Commercial Fridge Repairs Near Me</h2>
          <p>
            ...
            commercial fridge technician nearby can help reduce disruption when equipment
            develops a fault. Depending on local service coverage, commercial fridge repair
        ...
        <div className="commercial__cta">
          <a href="#contact" className="btn btn-primary">Find Commercial Fridge Repairs Near Me</a>
        </div>
      </div>
    </section>
  );
